...
export async function getSaleSubfolderFiles({ listingId, subfolderName, ...auth }) {
  ensureHomeSaleApiConnected();
  return homeSaleApiPost({ action: "getSaleSubfolderFiles", listingId, subfolderName, ...auth });
}
