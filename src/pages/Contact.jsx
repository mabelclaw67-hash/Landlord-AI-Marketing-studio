...
const CONTACT_COPY = {
  en: {
    requestTitle: "Contact VanIsland Property",
    requestDesc: "Tell us how we can help with a rental or property matter, a landlord question, or another company inquiry.",
    prepareTitle: "How we can help:",
    prepareItems: [
    ...
    interestedModule: "Inquiry Type",
    select: "-- Select --",
    services: [
      { value: "Rental / property inquiry", label: "Rental / property inquiry" },
      { value: "Landlord inquiry", label: "Landlord inquiry" },
      { value: "General company inquiry", label: "General company inquiry" },
      { value: "Other", label: "Other" },
    ],
    submitFailed: "Submission failed",
    sending: "Sending...",
    saved: "Your inquiry will be sent to our support team.",
    prototype: "Prototype mode: form is not transmitted.",
  },
  zh: {
    requestTitle: "联系 VanIsland Property",
    requestDesc: "您可以咨询租房或房产事宜、房东问题，或其他普通公司服务。",
    prepareTitle: "我们可以协助：",
    prepareItems: [
      "🏘️ 出租房源推广流程",
      "🏡 出售房源营销流程",
    ...
    interestedModule: "咨询类型",
    select: "-- 请选择 --",
    services: [
      { value: "租房 / 房产咨询", label: "租房 / 房产咨询" },
      { value: "房东咨询", label: "房东咨询" },
      { value: "一般公司咨询", label: "一般公司咨询" },
      { value: "其他", label: "其他" },
    ],
    submitFailed: "提交失败",
    sending: "正在发送...",
    saved: "您的咨询会发送给我们的支持团队。",
