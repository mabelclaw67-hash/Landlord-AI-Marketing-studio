...
const zh = {
  title: "租客报修与服务申请", verify: "验证租客身份", email: "电子邮箱", phone: "电话号码后四位", verifyButton: "验证", verifying: "正在验证…", securityCompleted: "安全检查已通过，请继续输入租客信息。", identityVerified: "租客身份验证成功", generic: "我们无法验证你的资料，请联系物业经理。",
